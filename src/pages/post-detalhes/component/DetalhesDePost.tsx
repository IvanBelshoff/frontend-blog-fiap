...
export const DetalhesDePost = () => {
  ...
  >(
    loaderData?.post?.foto?.url || `${Environment.BASE_URL}/profile/profile.jpg`
  );
  ...
  const [actionDataDeletePost, setActionDataDeletePost] =
    useState<IDetalhesDePostAction>();
